...
if __name__ == "__main__":
    ...
    # noise Networks
    parser.add_argument("--noisy", type=bool, default=False, help="Run experiment with noisy networks")
    # Prioritized Experience Replay args
    parser.add_argument("--per", type=bool, default=False, metavar="Prioritized Experience Replay",
                        help="Use experience replay memory or not")
    parser.add_argument("--memory_capacity", type=int, default=int(1e6), metavar="CAPACITY",
                        help="Experience replay memory capacity")
    parser.add_argument("--priority_exponent", type=float, default=0.5, metavar="ω",
                        help="Prioritised experience replay exponent (originally denoted α)")
    parser.add_argument("--priority_weight", type=float, default=0.4, metavar="β",
